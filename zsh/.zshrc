...
TERM_SETAF_3=$(tput setaf 2) # yellow
...
# @summary Print help for the get.raw command
# Created October 29, 2022
# @usage  $ textmate.snippets.get.raw.help
textmate.snippets.get.raw.help()
{
	echo "DEPRECATED: use jq"
	return 1
	echo "Usage:";
	echo "\t\x1B[34mtextmate.snippets.get.raw \x1B[0m \x1B[33m\"./snippet.file.name\" \x1B[0m <snippet-name> [<path>|code|kate]"
	echo "\tFile is initially searched in the home directory for VS Code snippets."
	echo "\tIf the last param is not specified, then simply print"
	echo "\tthe specified <snippet-name> (subfield) of the file"

} # textmate.snippets.get.raw.help end
...
alias luamake=/home/alex/.local/share/nvim/site/pack/packer/start/lua-language-server/3rd/luamake/luamake
